<?xml version="1.0" encoding="utf-8"?><xsl:stylesheet c:namespace-holder="keep-this-namespace" m:namespace-holder="keep-this-namespace" mq:namespace-holder="keep-this-namespace" om:namespace-holder="keep-this-namespace" version="1.0" xmlns:c="http://www.matracas.org/ns/cascada" xmlns:m="http://www.w3.org/1998/Math/MathML" xmlns:mq="http://mathweb.org/MathQuery" xmlns:mws="http://www.mathweb.org/mws/ns" xmlns:om="http://www.openmath.org/OpenMath" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="om:OMOBJ">
    ...
    <mws:query totalreq="yes" output="xml">
      <mws:expr>
  ...
  <xsl:template match="om:OMV[@name][@mq:generic]">
    <mws:qvar><xsl:value-of select="@name"/></mws:qvar>
  </xsl:template>
  ...
  <xsl:template match="om:OMA[count(*)=3 and *[1][self::om:OMS[@cd='list1' and @name='map']] and *[2][self::om:OMBIND[count(*)=3 and *[1][self::om:OMS[@cd='fns1' and @name='lambda']] and *[2][self::om:OMBVAR[count(*)=1]]]] and *[3][self::om:OMA[count(*)=3 and *[1][self::om:OMS[@cd='interval1' and @name='integer_interval']]]]]">
    <xsl:variable name="x" select="*[2]/*[2]/*[1]"/>
    <xsl:variable name="f" select="*[2]/*[3]"/>
